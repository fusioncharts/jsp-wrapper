...
--
-- Host: localhost
-- Generation Time: Nov 20, 2015 at 11:48 AM
...
--
CREATE DATABASE IF NOT EXISTS `fusioncharts_jspsample` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fusioncharts_jspsample`;
